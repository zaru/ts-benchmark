...
APPS=(
  ...
  "start:adonis|3005|AdonisJS standalone full (Node)::/::payload;AdonisJS standalone full DB (Node)::/db::db"
  "start:adonis:lean|3015|AdonisJS standalone lean (Node)::/::payload;AdonisJS standalone lean DB (Node)::/db::db"
