...
| 構成 | 単純 RPS | 単純 p50 ms | 単純 p99 ms | DB RPS | DB p50 ms | DB p99 ms |
| --- | --- | --- | --- | --- | --- | --- |
| Elysia 単体 (Bun) | **83,625** | 0.55 | 1.22 | 1,357 | 36.47 | 64.54 |
| Hono 単体 (Bun) | 71,707 | 0.65 | 1.41 | 1,396 | 35.42 | 60.69 |
| Elysia 単体 (Node) | 48,817 | 0.98 | 2.02 | 1,275 | 38.36 | 76.74 |
| Hono 単体 (Node) | 46,439 | 1.02 | 2.11 | 1,274 | 38.40 | 76.78 |
| Express 単体 (Bun) | 44,240 | 1.05 | 2.22 | 1,376 | 35.86 | 49.95 |
| NestJS 単体 Fastify (Node) | 39,717 | 1.21 | 2.46 | 1,214 | 39.31 | 78.29 |
| AdonisJS 単体 (lean) | 39,205 | 1.22 | 2.53 | 1,137 | — | — |
| Nuxt native | 37,223 | 1.24 | 2.61 | 1,335 | 42.92 | 59.90 |
| Express 単体 (Node) | 35,148 | 1.36 | 2.82 | 1,256 | 38.93 | 77.82 |
| NestJS 単体 Express (Node) | 31,724 | 1.53 | 3.13 | 1,230 | 39.70 | 79.50 |
...
| AdonisJS 単体 (full) | 11,575 | 4.31 | 8.58 | 1,048 | — | — |
...
成功率はいずれも 100%（全レスポンス 200・ボディは共通ペイロードと一致）。単純は約 0.5〜8.6ms、DB 集計は SQLite を 3 回クエリしてアプリ側で集計するため約 36〜50ms/リクエスト。AdonisJS の DB はスループットのみ計測（lean 1,137 / full 1,048 RPS）。
